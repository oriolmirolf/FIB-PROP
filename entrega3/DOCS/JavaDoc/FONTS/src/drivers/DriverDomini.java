...
public class DriverDomini {
    ...
    private void mostrarMenu() {
        ...
        System.out.println("17 — Afegir Expressió Booleana");
        System.out.println("18 — Eliminar Expressió Booleana");
        System.out.println("19 — Modificar Expressió Booleana");
        System.out.println("20 — Consultar Expressió Booleana");
    ...
    public void testOrdenarAutors() {
        System.out.println("S'està provant el mètode d'ordenar l'últim resultat de consulta d'autors.");
        int manera = -1;
        while (manera != 0 && manera != 1) {
            System.out.print("Escolleix si vols ordenar els resultats alfabèticament per nom (escriu 0) o per número de documents escrits (escriu 1): ");
    ...
    public void testOrdenarDocuments() {
        System.out.println("S'està provant el mètode d'ordenar l'últim resultat de consulta de documents.");
        int manera = -1;
        while (manera < 0 || manera > 4) {
            System.out.print("Escolleix si vols ordenar els resultats per semblança (escriu 0), per nom d'autor (escriu 1), per títol (escriu 2), per mida (escriu 3) o per data de creació (escriu 4): ");
            manera = Integer.parseInt(in.nextLine());
        }
    ...
    public void testLlistarExpressions() {
        System.out.println("S'està provant el mètode de llistar totes les expressions booleanes.");
    ...
    public void testGuardarDocument(){
        System.out.println("S'està provant el mètode de guardar Document actual.");
        try {
            cd.GuardarDocument();
        } catch (DocumentNoObert e) {
    ...
    public void testImportarDocument(){
        System.out.println("S'està provant el mètode de Importar Document");
    ...
    public void testExportarDocument(){
        System.out.println("S'està provant el mètode de Exportar Document");
