...
import FONTS.src.stubs.DocumentsStub;
...
public class ExpressioBooleanaTest {
     ...
     */
    public ExpressioBooleanaTest(String exp) throws ExpressioNoValida {
 ...
 */
    ...
    private HashSet<String> getDocumentsRecursiu(NodeExpressio n) {
        ...
        //Stub per testejar les funcions
        DocumentsStub DS = new DocumentsStub();
